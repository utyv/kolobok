...
Клавиша \* используется при вводе сочетаний букв. Например, комбинация ВКТ используется для ввода символа \/, и для ввода сочетания ЭТ. Если мы нажимаен ВКТ отдельно - получает слеш. Если нажимает ВКТ вместе с клавишей О, то получаем сочетание ЭТО. Но что если нам надо ввести сочетание ЭТ без гласной, например в составе слова ЭТНОГРАФИЯ? Тогда надо нажать комбинацию клавиш ВКТ вместе с клавишей \*. Другой пример - комбинация клавиш ПН. Если на правой стороне ничего не нажато, то эта комбинация вводит букву И. Если же на правой стороне, одновременно с комбинацией ПН, ввести букву, сочетания букв, или нажать клавишу \*, то комбинация ПН будет обозначать сочетание букв ПР.
