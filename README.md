...
В отличие от стенотайпинга, система КОЛОБОК позволяет вводить отдельные буквы, не перегружая при этом пользователя сложными аккордами. Это позволяет осваивать аккордовый ввод постепенно. После изучения алфавита, можно применять раскладку в повседневной работе, шаг за шагZом добавляя в свой арсенал новые аккорды. Небесполезным бонусом является возможность вводить любые буквы левой рукой. 
...
__Область букв__ выделена синим цветом. Это домашняя позиция для пальцев левой руки. С левой стороны согласные, с правой - гласные. 

Часть букв вводятся одноврененны нажатием двух клавищ. Например для ввода буквы "М" надо нажать клавиши К и Т, а для ввода буквы Ю надо нажать клавищи Е и Я.
...
__Дополнительный ряд указательного пальца левой руки__  -  область выделена красным. Backspace, Enter, Del соответственно. Комбинация ENT DEL срабатывает как нажатие Esc.

__Дополнительный ряд указательного пальца правой руки__  -  область выделена красным.

Клавиша \* используется при вводе сочетаний букв. Например, комбинация ВКТ используется для ввода символа \/, и для ввода сочетания ЭТ. Если мы нажимаен ВКТ отдельно - получает слеш. Если нажимает ВКТ вместе с клавишей О, то получаем сочетание ЭТО. Но что если нам надо ввести сочетание ЭТ без гласной, например в составе слова ЭТНОГРАФИЯ? Тогда надо нажать комбинацию клавиш ВКТ вместе с клавишей \*.
