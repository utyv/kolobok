...
Сочетания букв также вводятся с одновременным нажатием нескольких клавиш в этой области. В некоторых случаях также задействуется клавиша \*.
...
__Область препинаков__ выделена фиолетовым цветом. Аккорры этой области в комбинации с шифтом позволяют вводить до 30 различных символов. Рекомендуется настраивать эту область в зависимости от индивидуальных потребностей и предпочтений.

Знаки препинания также можно набирать аккордами левой рукой. Это позволяет работать одновременно клавиатурой и мышью. Знаки препинания продублированы справа чтобы сбалансировать нагрузку на руки, в случаях набора текста с большим количеством знаков препинания.
